...
1. Data as position or length

2. Perception of angles, slopes, and volumes
...
3. **[Horizontal length > vertical length(https://www.data-to-viz.com/caveat/hard_label.html)**: horizontal labels are easier to read
...
4. **[Data-ink ratio](https://www.data-to-viz.com/caveat/declutter.html)**: focus viewer's attention

--

5. **[Color](https://www.data-to-viz.com/caveat/color_com_nothing.html)**: should be meaningufl
...
+ **Nomograms**
  ...
  + Useful if number of interactions are releatively small
...
![](https://uc-r.github.io/public/images/analytics/ML_interpretation/pdp-1.png)

```{r echo=F, include=T, eval=T, out.width='80%', fig.align='center'}
knitr::include_graphics('img/pdp-example.jpg')
```
...
Just read [Tom Mock's summary of Jon Schwabish's principles](https://themockup.blog/posts/2020-09-04-10-table-rules-in-r/)
...
How to display different types of response variables
...
+ **Continuous**
  ...
  + 3 quartiles + formatting to emphasize middle quartile
